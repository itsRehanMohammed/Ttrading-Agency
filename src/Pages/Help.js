    ...
    <>
      ...
      <section className="text-gray-600 body-font px-10 ">
        <div className="container px-4 pt-14 pb-24 mx-auto">
          ...
          <div className="flex flex-wrap mt-8 -m-4 text-center md:space-x-4">
            <div className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10  mx-auto inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
            ...
            <div className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 mt-10 md:mt-0 mx-auto inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
